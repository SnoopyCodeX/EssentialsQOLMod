package ph.snoopycodex.essentialsqolmod.callback;
...
public interface ClickAirCallback {
    Event<ClickAirCallback> EVENT = EventFactory.createArrayBacked(ClickAirCallback.class, (listeners) -> (player, hand) -> {
